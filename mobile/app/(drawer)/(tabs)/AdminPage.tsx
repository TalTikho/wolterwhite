...
export const AdminPage = async () => {
  ...
  const saved = AsyncStorage.getItem("active_admin_restaurant_menu");
  const [selectedRestaurantForMenu, setSelectedRestaurantForMenu] = useState((saved))
  ...
  const handleManageMenu = (restaurant: Restaurant) => {
    ...
    AsyncStorage.setItem("active_admin_restaurant_menu", JSON.stringify(restaurant));
    ...
    return (
      <div className="admin-page-container">
        <button className="admin-back-btn" onClick={() => {
          ...
          await AsyncStorage.removeItem("active_admin_restaurant_menu");
